(function () {
  ...
  var buttonOrigPos = [];
  var textOrigPos = [];
  var normalButtonImg = 'file:///../download0/themes/matrix/img/botonNormal.png';
  var selectedButtonImg = 'file:///../download0/themes/matrix/img/botonSelecionado.png';
  ...
  var logoHeight = 350;
  var logo = new Image({
    url: 'file:///../download0/themes/matrix/img/Logo.png',
  ...
  for (var i = 0; i < menuOptions.length; i++) {
    ...
    if (useImageText) {
      ...
      btnText.x = btnX + 20;
      btnText.y = btnY + buttonHeight / 2 - 28 / 2;
      btnText.style = 'white';
    }
  ...
  if (useImageText) {
    ...
    exitText.x = exitX + 20;
    exitText.y = exitY + buttonHeight / 2 - 28 / 2;
  ...
  function updateHighlight() {
    ...
    for (var _i = 0; _i < buttons.length; _i++) {
      ...
      if (_i === currentButton) {
        ...
        _button.alpha = 1.0;
        _button.borderColor = 'rgb(0,255,0)';
